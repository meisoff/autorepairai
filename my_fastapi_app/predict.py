...
model_path = './models/model_lada.onnx'
...
labels = ["Granta", "Largus", "Vesta", "XRAY"]
...
img_path = 'C:\\Users\\Александр\\PycharmProjects\\autorepairai_2\\parser_autoru\\car_with_model\\test\\Vesta\\img_2.png'
predict(img_path)
